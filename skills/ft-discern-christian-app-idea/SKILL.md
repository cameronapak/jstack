...
Key posture: surrender the idea to God first. Scour to see if it already exists. Synergize before building solo. Sow with diligence. Share the story.
...
- `references/app-idea-journey.md` — The Surrender→Share framework with prayers, search guidance, and the open-handed collaboration posture
