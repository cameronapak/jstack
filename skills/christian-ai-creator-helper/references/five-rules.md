...
AI LLMs are good at organizing words into what it thinks we want to hear, but what if it decided to create its own Bible verse or slightly change a verse to fit a narrative it wants to portray?
...
Throughout the history of computing, we've been tasked with learning how to speak "machine" so that the computer would do what we wanted it to do. Now, we are learning how to speak to the computer in a way that's innately "human".
...
Anthropomorphising (or humanizing) AI can be very dangerous. Some examples of dangerous AI applications that do this are friend.com or replika. An example of dangerous AI application in the faith-based space is the [Text with Jesus](https://textwith.me/jesus/) app. *(I am not referencing these specific apps to be mean.)*

AI should NOT masquerade as a being from the Bible, because it's dangerous and can lead people astray. AI that is overtly clear about being non-sentient, or rather a robot, sets healthy emotional and social boundaries. AI output must clearly identify as AI, not human.

**Related Resources:**
- [How anthropomorphism hinders AI education](https://www.raspberrypi.org/blog/ai-education-anthropomorphism/)
- [A Christian's Perspective on Artificial Intelligence](https://christoverall.com/article/longform/a-christians-perspective-on-artificial-intelligence/)
...
- [The Ethics of AI: How Far Is Too Far?](https://www.barna.com/research/ai-ethics/)

## 5. AI output must balance grace and truth, while not neglecting one of the two.

Dr. Henry Cloud paints it so well when explaining why we need both grace and truth. Read [Growth Takes Grace and Truth](https://www.cloudtownsend.com/growth-takes-grace-and-truth/).

AI output prioritizing truth alone can feel like law and judgement without relationship, while AI output prioritizing grace alone can feel like license to sin without direction. Jesus was full of grace and truth. We need both.
...
*(If your app isn't listed, it doesn't mean your app doesn't meet these criteria.)*
...
- [The AI Attribute Architecture](https://vimeo.com/1153419142?fl=pl&fe=sh) — James Kelly, FaithTech (2026)
...
- [Artificial intelligence in the service of the Bible](https://media-1.jesus.net/media/6041/Whitepaper-AI---Ask-Jesus.net.pdf) — Jesus.net
- [Gloo Open](https://ai.gloo.com/releases/announcing-gloo-open)
- [AI Collective](https://aicollective.faith/)
- [Plea for an open sourced Christian Artificial Intelligence](https://docs.google.com/document/d/1sfNbXpmqgT-dnL0pCjTqjuSOnA6Jmhfu/edit)
- [AI Ethical Framework](https://lausanne.org/global-analysis/ai-ethical-framework) — Lausanne Movement

*— from Cam Pak, someone who is deeply fascinated with AI and making it obedient to the Lord Jesus*
